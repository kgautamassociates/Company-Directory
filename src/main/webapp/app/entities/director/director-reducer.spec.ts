...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DIRECTOR_LIST actions', async () => {
    ...
    it('dispatches SEARCH_DIRECTORS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_DIRECTOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DIRECTOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DIRECTOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DIRECTOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DIRECTOR actions', async () => {
      const expectedActions = [
        {
